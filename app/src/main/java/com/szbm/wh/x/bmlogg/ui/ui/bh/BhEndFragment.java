...
import com.szbm.wh.x.bmlogg.databinding.BhEndFragmentBinding;
...
public class BhEndFragment extends ImagesGeoDateFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.bh_end_fragment, container, false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this,factory).get(BhEndViewModel.class);
